        ...
        <section class="about">
            <div id="main"> 
                <div class="about-text">
                    <h2>Bienvenue sur YO<span>U-V</span></h2>
                    <h5>Créateur de <span>Sneakers UV</span></h5>
                    <p>Adoptez le style Youv et choisissez le style UV !</p>
                    <button type="button"><a href="connexion.php">Connexion</button></a>
                </div>
            </div>
        </section>
